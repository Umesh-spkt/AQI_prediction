...
model = joblib.load(r'C:\Users\sapko\OneDrive\Desktop\project\multilinear\regressionmodel.pkl')
...
def homepage(request):
    ...
    if api[0]['Category']['Name'] == 'Good':
        ...
        Category_Description = "(51-100) Air quality is acceptable. However, there may be a risk for some people, who are unusually sensitive to air pollution."
    ...
    if api[1]['Category']['Name'] == 'Good':
        ...
        Category_Description1 = "(51-100) Air quality is acceptable. However, people more sensitive to air pollution may be at risk."
    ...
    return render(request, 'main/homepage.html',
                  {'api': api, 'Category_Description': Category_Description, 'Category_color': Category_color,
                   'Category_Description1': Category_Description1, 'Category_color1': Category_color1, }, )
